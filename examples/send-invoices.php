...
$invoice1Header = (new \Baradaran\Moadian\Dto\InvoiceHeaderDto())
    ...
    ->setTvop(null)
    ->setTax17(0);
$invoice1BodyDto = (new \Baradaran\Moadian\Dto\InvoiceBodyDto())
    ...
    ->setBsrn(null)
    ->setTsstam(109_000);
$invoice1PaymentDto = (new \Baradaran\Moadian\Dto\InvoicePaymentDto())
    ->setIinn(null)
    ->setAcn(null)
    ->setTrmn(null)
    ->setTrn(null)
    ...
    ->setPid(null)
    ->setPdt(null);
$invoice1Dto = new \Baradaran\Moadian\Dto\InvoiceDto();
...
$invoice2Header = (new \Baradaran\Moadian\Dto\InvoiceHeaderDto())
    ...
    ->setTvop(null)
    ->setTax17(0);
$invoice2BodyDto = (new \Baradaran\Moadian\Dto\InvoiceBodyDto())
    ...
    ->setBsrn(null)
    ->setTsstam(87_200);
$invoice2PaymentDto = (new \Baradaran\Moadian\Dto\InvoicePaymentDto())
    ->setIinn(null)
    ->setAcn(null)
    ->setTrmn(null)
    ->setTrn(null)
    ...
    ->setPid(null)
    ->setPdt(null);
$invoice2Dto = new \Baradaran\Moadian\Dto\InvoiceDto();
